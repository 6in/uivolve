  ...
  items: [
    {
      ...
      itemId: 'opIcons',
      title: '操作',
      layout: { type: 'grid', columns: 3, gap: 6 },
      items: [
        { text: 'fa-plus', iconCls: 'x-fa fa-plus' },
        { text: 'fa-pen', iconCls: 'x-fa fa-pen' },
        { text: 'fa-trash', iconCls: 'x-fa fa-trash' },
        { text: 'fa-floppy-disk', iconCls: 'x-fa fa-floppy-disk' },
        { text: 'fa-copy', iconCls: 'x-fa fa-copy' },
        { text: 'fa-rotate', iconCls: 'x-fa fa-rotate' },
        { text: 'fa-magnifying-glass', iconCls: 'x-fa fa-magnifying-glass' },
        { text: 'fa-filter', iconCls: 'x-fa fa-filter' },
        { text: 'fa-download', iconCls: 'x-fa fa-download' },
        { text: 'fa-upload', iconCls: 'x-fa fa-upload' },
        { text: 'fa-print', iconCls: 'x-fa fa-print' },
        { text: 'fa-file-export', iconCls: 'x-fa fa-file-export' },
      ],
    ...
    },
    {
      ...
      layout: { type: 'grid', columns: 3, gap: 6 },
      items: [
        { text: 'fa-house', iconCls: 'x-fa fa-house' },
        { text: 'fa-gear', iconCls: 'x-fa fa-gear' },
        { text: 'fa-user', iconCls: 'x-fa fa-user' },
        { text: 'fa-users', iconCls: 'x-fa fa-users' },
        { text: 'fa-bell', iconCls: 'x-fa fa-bell' },
        { text: 'fa-envelope', iconCls: 'x-fa fa-envelope' },
        { text: 'fa-calendar-days', iconCls: 'x-fa fa-calendar-days' },
        { text: 'fa-folder-open', iconCls: 'x-fa fa-folder-open' },
        { text: 'fa-table', iconCls: 'x-fa fa-table' },
        { text: 'fa-chart-line', iconCls: 'x-fa fa-chart-line' },
        { text: 'fa-database', iconCls: 'x-fa fa-database' },
        { text: 'fa-cloud-arrow-up', iconCls: 'x-fa fa-cloud-arrow-up' },
      ],
      defaults: { xtype: 'button' },
    },
    {
      ...
      layout: { type: 'grid', columns: 3, gap: 6 },
      items: [
        { text: 'fa-circle-check', iconCls: 'x-fa fa-circle-check' },
        { text: 'fa-circle-xmark', iconCls: 'x-fa fa-circle-xmark' },
        { text: 'fa-triangle-exclamation', iconCls: 'x-fa fa-triangle-exclamation' },
        { text: 'fa-circle-info', iconCls: 'x-fa fa-circle-info' },
        { text: 'fa-circle-question', iconCls: 'x-fa fa-circle-question' },
        { text: 'fa-lock', iconCls: 'x-fa fa-lock' },
        { text: 'fa-lock-open', iconCls: 'x-fa fa-lock-open' },
        { text: 'fa-star', iconCls: 'x-fa fa-star' },
        { text: 'fa-clock', iconCls: 'x-fa fa-clock' },
        { text: 'fa-ban', iconCls: 'x-fa fa-ban' },
        { text: 'fa-check', iconCls: 'x-fa fa-check' },
        { text: 'fa-xmark', iconCls: 'x-fa fa-xmark' },
      ],
      defaults: { xtype: 'button' },
    },
    {
...
export const samples: Sample[] = [
  ...
  { name: '編集グリッド (セル部品)', code: editableGridSample },
  { name: 'Font Awesome アイコン', code: faSample },
]
